...
Το log file περιλαμβάνει: Τις διεργασίες που έχουν τερματιστεί, με τα ανάλογα στοιχεία τους, την εικόνα της μνήμης τη στιγμή που τερματίζει η προσομοίωση, και την εικόνα της 
pending list τη στιγμή τερματισμού.


Δεδομένου ότι δεν πρόλαβα να υπολοποιήσω την εκτύπωση του δυαδικού δέντρου στο log file εκτυπώνω 
το δέντρο στο output. 

Επίσης δεν έχω υλοποιήσει την *αυτόματη* απομάκρυνση των διεργασιών από την μνήμη μετά το πέρας
