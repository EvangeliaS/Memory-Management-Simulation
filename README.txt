...
Η προσομοίωση σταματά όταν μηδενιστεί ο χρόνος D, και το πρόγραμμα τερματίζει.

Σε σχόλιο στην main του M.cpp υπάρχουν υλοποιημένες 3 εκτελέσεις του προγράμματος
Μια για κάθε αλγόριθμο. Σε κάθε υλοποίηση υπάρχουν τα αντίστοιχα αποτελέσματα στο 
ανάλογο log file.

Το log file περιλαμβάνει: Την εικόνα της μνήμης τη στιγμή που τερματίζει η προσομοίωση.
Δηλαδή τους κόμβους της λίστας ή του δέντρου, με τις διεργασίες που φιλοξενούν.
πχ: (445,454) Block size: 10, Process details: 45752 size: 10 lifetime: 1 Start time: 81
start time: αποτελεί η μονάδα χρόνου κατά την οποία η διεργασία τοποθετήθηκε στη μνήμη.


Δεδομένου ότι δεν πρόλαβα να υπολοποιήσω την εκτύπωση του δυαδικού δέντρου στο log file εκτυπώνω 
το δέντρο στο output. Επίσης δεν έχω υλοποιήσει την *αυτόματη* απομάκρυνση των διεργασιών από την μνήμη μετά το πέρας
της ζωής τους, αλλά οι συναρτήσεις διαγραφής που απομακρύνουν τους κόμβους από τη μνήμη, και η συνάρτηση που τοποθετεί 
στη μνήμη pending processes από την L, έχουν υλοποιηθεί και λειτουργούν επιτυχώς.
